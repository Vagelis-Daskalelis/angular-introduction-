...
@Component({
  ...
  styleUrl: './list-group-menu.component.scss'
})
export class ListGroupMenuComponent {
  menu : MenuItem[] = [
    ...
    {text: 'Simple Datatable Example', routerLink: 'simple-example'},
    {text: 'Component Output Example', routerLink:
    ...
    {text: 'User Registration Example', routerLink:
      'user-registration-example'
    },
    {text: 'Restricted Content Example', routerLink:
